...
Spring已经从在Java EE做依赖注入的框架发展为包罗AOP、MVC、数据持久化、消息传递、安全的[Spring全家桶](https://spring.io/projects)生态，甚至已经把魔掌伸向命令行程序和手机应用开发。我们就来说明一下怎么用Spring。
...
测试文件`src/main/java/com/github/chungkwong/toy/BasicApplicationTests.java`形如：
